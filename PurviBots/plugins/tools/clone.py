...
from PurviBots.utils.database import get_assistant, clonebotdb
from PurviBots.utils.database.clonedb import has_user_cloned_any_bot
from config import LOGGER_ID, CLONE_LOGGER
import requests
from PurviBots.utils.decorators.language import language
import pyrogram.errors

from PurviBots.utils.database.clonedb import get_owner_id_from_db
from config import SUPPORT_CHAT, OWNER_ID

from datetime import datetime
CLONES = set()

C_BOT_DESC = "Wᴀɴᴛ ᴀ ʙᴏᴛ ʟɪᴋᴇ ᴛʜɪs? Cʟᴏɴᴇ ɪᴛ ɴᴏᴡ! ✅\n\nVɪsɪᴛ: @shehzaadi_bot ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ!\n\n - Uᴘᴅᴀᴛᴇ: @Love_Bot_143\n - Sᴜᴘᴘᴏʀᴛ: @Love_familysupport"
